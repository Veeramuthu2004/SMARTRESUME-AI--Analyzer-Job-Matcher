...
const env = {
  ...
  clientUrl:
    ...
    (isProduction
      ? "https://smartresume-ai-analyzer-jvzmkjnge-veeradpi12-2273s-projects.vercel.app"
      : "http://localhost:5173"),
  jwtSecret:
    process.env.JWT_SECRET ||
    (isProduction ? "production-fallback-access-secret" : ""),
  jwtRefreshSecret:
    process.env.JWT_REFRESH_SECRET ||
    (isProduction ? "production-fallback-refresh-secret" : ""),
